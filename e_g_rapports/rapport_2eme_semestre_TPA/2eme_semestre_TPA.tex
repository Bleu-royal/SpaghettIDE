...
\section{Ajouts bonus}
	...
	\subsection{L'assistance vocale}
		...
		Il existe sous Mac une commande "say" qui permet de lire dans la langue du système le texte rentré après à l'aide de la synthèse vocale de la machine. C'est ce que nous avons utilisé ici, mais cette commande n'existant que sous Mac, et n'ayant pas trouvé d'alternatives, cette fonctionnalité n'est donc pas disponnible ailleurs (rassurez-vous, vous ne ratez pas grand chose !).\\
		
		L'assistance vocale ne fait que lire les messages apparaissant dans la barre de status comme : "Le projet séléctionné a bien été ouvert." par exemple.\\
	...
	On l'active au même endroit que pour l'assistance vocale, et elle est disponnible sous toutes les plateformes !\\
